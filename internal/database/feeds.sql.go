...
const getNextFeedToFech = `-- name: GetNextFeedToFech :one
...
func (q *Queries) GetNextFeedToFech(ctx context.Context) (Feed, error) {
	row := q.db.QueryRowContext(ctx, getNextFeedToFech)
	var i Feed
	err := row.Scan(
		&i.ID,
		&i.CreatedAt,
